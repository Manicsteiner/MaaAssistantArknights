    ...
    public class AsstProxy
    {
        ...
        */
        ...
        public void Init()
        {
            ...
            AsstSetInstanceOption(InstanceOptionKey.GoldenBorder, Instances.SettingsViewModel.GoldenBorder ? "1" : "0");
            AsstSetInstanceOption(InstanceOptionKey.ResizeWindow, Instances.SettingsViewModel.ResizeWindow ? "1" : "0");
        ...
        {
            if (Instances.SettingsViewModel.AutoDetectConnection && !Instances.SettingsViewModel.IsWSATouchMode())
            {
